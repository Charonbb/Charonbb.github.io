...
  return `Junior Quality Assurance (QA) Specialist with 10 months of practical experience in functional, smoke, and regression testing. Proficient in using modern QA tools such as Jira, Postman, and Swagger. Motivated to advance in test automation with Python and Selenium, with a strong focus on delivering high-quality, reliable products in Agile environments.`;
})();
